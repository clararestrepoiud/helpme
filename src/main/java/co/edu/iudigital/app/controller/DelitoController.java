...
@SwaggerDefinition(tags = { @Tag(name = "Delitos", description = "Gestion de API delitos") })
...
public class DelitoController {
	 ...
	 * esto es otra opcion
	 * 
	 * @Autowired public DelitoController( IDelitoService delitoService) {
	 * this.delitoService = delitoService }
	 */

	@ApiOperation(value = "Obtiene todos los delitos", response = DelitoDto.class, responseContainer = "List", produces = "application/json", httpMethod = "GET")
	@GetMapping
	...
	@ApiOperation(value = "Obtiene un delito por su id", response = Delito.class, produces = "application/json", httpMethod = "GET")
	@ResponseStatus(code = HttpStatus.OK)
	...
	@ApiOperation(value = "Guarda un delito", response = Delito.class, produces = "application/json", httpMethod = "POST")
	...
	@ApiOperation(value = "Elimina un delito por id", produces = "application/json", httpMethod = "POST")
